...
//lpm_shiftreg LPM_DIRECTION="LEFT" LPM_WIDTH=7 aclr clock q shiftin
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) shift_reg <= 7'b0;
		else  shift_reg <= shift_node;
	assign
		q = shift_reg,
		shift_node = {shift_reg[5:0], shiftin};
endmodule //registro7_shift_reg
//VALID FILE
...
module registro7 (
	...
	registro7_shift_reg	registro7_shift_reg_component (
				.aclr (aclr),
				.clock (clock),
				.shiftin (shiftin),
				.q (sub_wire0));
