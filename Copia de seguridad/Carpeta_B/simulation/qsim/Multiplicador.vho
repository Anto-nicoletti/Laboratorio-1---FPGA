...
ARCHITECTURE structure OF MultiplicadorBlock2 IS
...
SIGNAL \b2v_13|S~combout\ : std_logic;
SIGNAL \b2v_inst14|Cout~0_combout\ : std_logic;
SIGNAL \b2v_inst14|S~0_combout\ : std_logic;
...
\b2v_13|S\ : cycloneiii_lcell_comb
-- Equation(s):
-- \b2v_13|S~combout\ = (\A0~input_o\ & (\B1~input_o\ $ (((\A1~input_o\ & \B0~input_o\))))) # (!\A0~input_o\ & (\A1~input_o\ & (\B0~input_o\)))
...
\b2v_inst14|Cout~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \b2v_inst14|Cout~0_combout\ = (\A0~input_o\ & (\A1~input_o\ & (\B0~input_o\ & \B1~input_o\)))
...
PORT MAP (
	...
	datac => \B0~input_o\,
	datad => \B1~input_o\,
	combout => \b2v_inst14|Cout~0_combout\);

-- Location: LCCOMB_X80_Y1_N4
\b2v_inst14|S~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \b2v_inst14|S~0_combout\ = (\A1~input_o\ & (\B1~input_o\ & ((!\B0~input_o\) # (!\A0~input_o\))))
